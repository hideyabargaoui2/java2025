...
public class ShowOffreController implements Initializable {
    ...
    private void ajouterReservation() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/OffreReservation/AddReservation.fxml"));
    ...
    private void editReservation(Reservation reservation) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/OffreReservation/EditReservation.fxml"));
            Parent root = loader.load();
