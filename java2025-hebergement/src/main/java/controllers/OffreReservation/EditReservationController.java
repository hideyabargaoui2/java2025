...
public class EditReservationController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        statutCombo.setItems(FXCollections.observableArrayList(
                "confirmée", "annulée", "en attente", "terminée"
        ));
    ...
    private void populateFields() {
        ...
        statutCombo.getSelectionModel().select(currentReservation.getStatut());
    }
    ...
    private void enregistrer() {
        try {
            ...
            if (isEditMode) {
                ...
                currentReservation.setStatut(statut);
                ...
                newReservation.setStatut(statut);
