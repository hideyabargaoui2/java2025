...
public class IndexReservationController implements Initializable {
    ...
    private void gotores() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/offreReservation/indexOffre.fxml"));
    ...
    private void openReservationForm(Reservation reservation) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/offreReservation/ReservationForm.fxml"));
            Parent root = loader.load();
            ...
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            stage.setTitle(reservation == null ? "Nouvelle Réservation" : "Modifier Réservation");
            stage.show();
        } catch (IOException e) {
