...
public class IndexOffreController implements Initializable {
    ...
    private VBox createOffreCard(Offre offre) {
        ...
        HBox buttonsBox = new HBox(10, detailsBtn, editBtn, deleteBtn);
        ...
        editBtn.setOnAction(e -> editOffre(offre));
        deleteBtn.setOnAction(e -> deleteOffre(offre));
    ...
    private void gotores() {
             try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/offreReservation/indexReservation.fxml"));
    ...
    private void showOffreDetails(Offre offre) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/OffreReservation/showOffre.fxml"));
            Parent root = loader.load();
    ...
    private void editOffre(Offre offre) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/OffreReservation/editOffre.fxml"));
            Parent root = loader.load();

            EditOffreController controller = loader.getController();
            controller.setOffre(offre);
            controller.setIndexController(this); // Pour rafraîchir la liste après modification
    ...
    private void ajouterOffre() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/OffreReservation/newOffre.fxml"));
            Parent root = loader.load();

            NewOffreController controller = loader.getController();
            controller.setIndexController(this); // Pour rafraîchir la liste après ajout
